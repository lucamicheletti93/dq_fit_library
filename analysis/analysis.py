...
def main():
    ...
    if args.plot_results:
        ...
        histStatYieldPsi2sPt.Draw("EP SAME")
        legendYieldJpsiVsPsi2sPt.Draw("SAME")
        canvasYieldJpsiPt.SaveAs("{}/jpsi_vs_psi2s_yield_vs_pt.pdf".format(outputDir))
        ...
        graStatRatioInt = TGraphErrors(1, intCentr, measStatRatioInt, intWidth, statMeasStatRatioInt)
        graStatRatioInt.SetLineColorAlpha(ROOT.kGray+1, 0.3)

        graSystRatioInt = TGraphErrors(1, intCentr, measSystRatioInt, intWidth, systMeasSystRatioInt)
        graSystRatioInt.SetFillColorAlpha(ROOT.kGray+1, 0.3)
        ...
        histGridRatioPt.GetYaxis().SetTitle("#psi(2S) / J/#psi")
        histGridRatioPt.Draw()
        #graSystRatioInt.Draw("E2 SAME")
        #graStatRatioInt.Draw("EP SAME")
        graSystRatioPtRun2.Draw("E2 SAME")
        graStatRatioPtRun2.Draw("EP SAME")
        graSystRatioPt.Draw("E2 SAME")
        graStatRatioPt.Draw("EP SAME")
        ...
        canvasRatioPtVsInt = TCanvas("canvasRatioPtVsInt", "canvasRatioPtVsInt", 800, 600)
        ROOT.gPad.SetLogy(1)
        histGridRatioPt  = TH2F("histGridRatioPt", "", 100, 0, 20, 100, 0.001, 0.10)
        histGridRatioPt.GetXaxis().SetTitle("#it{p}_{T} (GeV/#it{c}")
        histGridRatioPt.GetYaxis().SetTitle("#psi(2S) / J/#psi")
        ...
        graStatRatioPt.Draw("EP SAME")
        legendRatioPt.Draw("EP SAME")
        canvasRatioPtVsInt.SaveAs("{}/psi2s_over_jpsi_vs_pt_vs_int.pdf".format(outputDir))
        ...
        legendAxePt = TLegend(0.59, 0.29, 0.79, 0.59, " ", "brNDC")
        SetLegend(legendAxePt)
        legendAxePt.AddEntry(histAxeJpsiPt, "J/#psi (Run2 MC)", "L")
        legendAxePt.AddEntry(histAxePsi2sPt, "#psi(2S) (Run2 MC)", "L")
